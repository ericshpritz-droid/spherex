...
const config: CapacitorConfig = {
  ...
  server: {
    // Hot-reload against the Lovable sandbox preview while developing.
    // Comment this out for production / TestFlight builds so the app loads
    // bundled assets from `dist/`.
