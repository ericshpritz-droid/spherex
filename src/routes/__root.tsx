...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#08041C" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Geist:wght@300;400;500;600;700&family=Geist+Mono:wght@400;500;600&display=swap" },
    ],
  }),
...
function RootComponent() {
  // Initialize native shell (status bar, keyboard, viewport lock, gesture guards)
  // exactly once when running inside Capacitor. No-op on web.
  if (typeof window !== "undefined") {
    import("../mutual/native/initNative").then(({ initNativeShell }) => {
      initNativeShell();
    }).catch(() => {});
  }
  return (
